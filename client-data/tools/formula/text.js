...
(function () { //Code isolation
	...
	// Обработка клика на поле после выбора инструмента
	...
	function startEdit() {
		...
		input.style.top=curText.y*Tools.scale-scrollY - 32 +'px';
		input.focus();
	...
	// Добавление инструмента в панель
	Tools.add({
		"icon": "ƒ()",
    "name": "Formula",
		"listeners": {
      ...
      "changeTool":"5"
		...
		"draw": draw,
		"mouseCursor": "text",
		"stylesheet": "tools/formula/text.css"
	});
})(); //End of code isolation


interact('#textToolInput')
  .resizable({
